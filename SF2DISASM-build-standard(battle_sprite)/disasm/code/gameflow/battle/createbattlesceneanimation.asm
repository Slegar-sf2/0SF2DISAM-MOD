...
@CheckMuddled:
                ...
                move.b  (a4),d0
                jsr     GetClass        
                move.b   #ALLYBATTLEANIMATION_SPECIAL_MMNK,d5 ; HARDCODED class and battle animation indexes
                cmpi.w  #CLASS_MMNK,d1  ; MMNK
                beq.w   @DetermineSpecialCritical
                move.b   #ALLYBATTLEANIMATION_SPECIAL_RBT,d5
                cmpi.w  #CLASS_RBT,d1   ; RBT
                beq.w   @DetermineSpecialCritical
                move.b   #ALLYBATTLEANIMATION_SPECIAL_BRGN,d5
...
@CheckCastSpell:
                ...
                move.b  (a4),d0
                jsr     GetClass        
                move.b   #ALLYBATTLEANIMATION_SPECIAL_MNST,d5
                cmpi.w  #CLASS_MNST,d1  ; MNST
                beq.w   @AnimateSprite
                jsr     GetEnemyIndex   
                move.b   #ENEMYBATTLEANIMATION_SPECIAL_HELL_HOUND,d5
                cmpi.w  #ENEMY_HELL_HOUND,d1 ; HARDCODED enemy indexes
                beq.w   @AnimateSprite
                cmpi.w  #ENEMY_CERBERUS,d1
                beq.w   @AnimateSprite
                move.b   #ENEMYBATTLEANIMATION_SPECIAL_DEVIL_GRIFFIN,d5
                cmpi.w  #ENEMY_DEVIL_GRIFFIN,d1
                beq.w   @AnimateSprite
                move.b   #ENEMYBATTLEANIMATION_SPECIAL_ODD_EYE,d5
